...
/**
 * manages data written into a 2D (C)ommand (L)ine (I)nterface console
 * TODO move into the CLI namespace
 */
class CLIBuffer
{
public:
	/** use a bunch of already written code */
	typedef V2I Coord;
...
public:
	...
	int getNumberOfBuffers(){
		return (m_historyBuffer != 0)?((m_historyBuffer != 0)?2:1):0;
	}
